  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'dynastie/de-mikpone',         name: 'frontend.dynastie.mikpone',        meta: { title: 'De-Mikponê' },           component: () => import('@/views/frontend/dynastie/mikpone.vue') },
        ...
        { path: 'recits/houyi',                name: 'frontend.recits.houyi',            meta: { title: 'DêHouyi' },              component: () => import('@/views/frontend/recits/houyi.vue') },
        ...
        { path: 'diaspora/france-gabon',       name: 'frontend.diaspora.france-gabon', meta: { title: 'France Gabon' },       component: () => import('@/views/frontend/diaspora/france-gabon.vue') },
