...
const story = [
  'Dê-Mèssè est la lignée qui donne son nom à notre dynastie. Inscrite dans la longue succession des dix-huit rois du royaume de Hogbonou (Porto-Novo), elle marque une période brève mais hautement symbolique : cinq années de règne (1752 — 1757) qui ont profondément contribué à la mémoire collective de la famille royale.',
  'Le règne de Dê-Mèssè s’inscrit au cœur du XVIIIᵉ siècle, époque où le royaume fondé par Tê Agbanlin avait déjà près d’un siècle d’existence et continuait à structurer son organisation administrative et politique. Les ministres traditionnels — Migan, Gogan, Mewou, Akplogan, Awatagan — assuraient le bon fonctionnement de la cour.',
  '[TODO contenu client] Les détails biographiques, les hauts faits et les réalisations attribués au règne de Dê-Mèssè sont conservés dans les traditions orales et les archives de la dynastie. Cette section sera enrichie avec les apports du Conseil des Sages.',
]
...
<template>
  <LigneePage
    name="Dê-Mèssè"
    period="1752 — 1757"
    intro="La lignée fondatrice qui donne son nom à notre dynastie."
    :image="imgPortoNovo"
    image-alt="Royaume de Porto-Novo — Hogbonou"
    :story="story"
    :figures="figures"
    :documents="documents"
    :next="{ label: 'Dê-Ayikpe', to: { name: 'frontend.dynastie.ayikpe' } }"
  />
</template>
