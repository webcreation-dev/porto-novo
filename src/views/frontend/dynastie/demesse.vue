...
const figures = [
  { name: 'Dê-Messe',                            period: '1752 — 1757',        role: 'Roi de Hogbonou',  description: 'Souverain dont le nom est aujourd’hui porté par la dynastie.' },
  { name: 'Dê Hakpon, Dê Lokpon, Dê Houdé',      period: 'Avant Dê-Messe',     role: 'Prédécesseurs',     description: 'Trois rois qui ont précédé Dê-Messe dans la succession des souverains de Hogbonou.' },
  { name: 'Dê Houyi, Dê Gbégnon, Dê Ayikpé',     period: 'Après Dê-Messe',     role: 'Successeurs',       description: 'Souverains ayant succédé à Dê-Messe dans la longue lignée royale de Porto-Novo.' },
]
