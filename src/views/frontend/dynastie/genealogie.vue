...
const figures = [
  ...
  { name: 'Dê-Mèssè',                            period: '1752 — 1757',      role: 'Roi éponyme de la dynastie',     description: 'Souverain dont le nom est porté par la dynastie aujourd’hui.' },
...
<template>
  <LigneePage
    ...
    :next="{ label: 'Documents Dê-Mèssè', to: { name: 'frontend.dynastie.documents' } }"
  />
</template>
