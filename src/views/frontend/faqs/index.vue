...
const categories = [
  {
    eyebrow: 'La dynastie',
    title: 'À propos de la Dynastie Royale Dê-Mèssè',
    icon: 'mdi:crown',
    items: [
      {
        q: 'Qu’est-ce que la Dynastie Royale Dê-Mèssè ?',
        a: 'La Dynastie Royale Dê-Mèssè est l’une des grandes lignées issues du Royaume de Hogbonou (Porto-Novo, Bénin), fondé au 17ᵉ siècle par Tê Agbanlin. Le nom Dê-Mèssè fait référence à la lignée royale qui régna entre 1752 et 1757.',
      },
      {
      ...
      {
        q: 'Quelle est la différence entre Dê-Mèssè, Dê-Ayikpe et Dê-Tognon ?',
